...
setup(
    name="symmstate",  # Name of your package
    version="1.0.0",  # Package version
    description="SymmState: Unlocking the elegance of symmetry in the solid state ",
    ...
    install_requires=["numpy", "pymatgen", "matplotlib", "scipy", ""],
    entry_points={
        "console_scripts": [
